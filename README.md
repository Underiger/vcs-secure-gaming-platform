...
logging. Correctness and robustness are evidenced by 700 passing unit and
...
後台。系統正確性與強健性由 700 條單元／整合測試、涵蓋五類攻擊向量之安全
...
- **700 條單元／整合測試全數通過**（本快照發布前於目標硬體實跑驗證），
